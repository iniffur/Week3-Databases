...
posts, title, post_contents, comments, comments_contents, author
```
...
| Record                | Properties          |
| --------------------- | ------------------  |
| posts                 | title, post_contents
| comments              | comments_contents, author

1. Name of the first table (always plural): `posts` 

    Column names: `title`. `post_contents`

2. Name of the second table (always plural): `comments` 

    Column names: `comments_contents`, `author`
