...
# user_account.email_address = 'fake@fake.com'
...
user_accounts[0].email_address # =>  'fake@fake.com'
user_accounts[0].username # =>  'dave_franks'


user_accounts[1].id # =>  2
user_accounts[1].email_address # =>  'definitelyfake@fake.com'
user_accounts[1].username # =>  'mick_franks'
...
user_account.id # =>  1
user_account.email_address # =>  'fake@fake.com'
user_account.username # =>  'dave_franks'
