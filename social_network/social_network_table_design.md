...
user_account, email_address, username, posts, title, content, num_of_views
```
...
| post                  | title, content, num_of_views
...
2. Name of the second table (always plural): `posts` 
    ...
    Column names: `title`, `content`, `num_of_views`
...
-> A posts BELONGS TO a user_account
